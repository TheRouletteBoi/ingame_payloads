...
enum opt_code
{
  ...
  OPT__param_rs6000_density_load_num_threshold_ = 286,/* --param=rs6000-density-load-num-threshold= */
  OPT__param_rs6000_density_load_pct_threshold_ = 287,/* --param=rs6000-density-load-pct-threshold= */
  OPT__param_rs6000_density_pct_threshold_ = 288,/* --param=rs6000-density-pct-threshold= */
  OPT__param_rs6000_density_penalty_ = 289,  /* --param=rs6000-density-penalty= */
  OPT__param_rs6000_density_size_threshold_ = 290,/* --param=rs6000-density-size-threshold= */
  OPT__param_rs6000_vect_unroll_issue_ = 291,/* --param=rs6000-vect-unroll-issue= */
  OPT__param_rs6000_vect_unroll_limit_ = 292,/* --param=rs6000-vect-unroll-limit= */
  OPT__param_rs6000_vect_unroll_reduc_threshold_ = 293,/* --param=rs6000-vect-unroll-reduc-threshold= */
  OPT__param_sccvn_max_alias_queries_per_access_ = 294,/* --param=sccvn-max-alias-queries-per-access= */
  OPT__param_scev_max_expr_complexity_ = 295,/* --param=scev-max-expr-complexity= */
  OPT__param_scev_max_expr_size_ = 296,      /* --param=scev-max-expr-size= */
  OPT__param_sched_autopref_queue_depth_ = 297,/* --param=sched-autopref-queue-depth= */
  OPT__param_sched_mem_true_dep_cost_ = 298, /* --param=sched-mem-true-dep-cost= */
  OPT__param_sched_pressure_algorithm_ = 299,/* --param=sched-pressure-algorithm= */
  OPT__param_sched_spec_prob_cutoff_ = 300,  /* --param=sched-spec-prob-cutoff= */
  OPT__param_sched_state_edge_prob_cutoff_ = 301,/* --param=sched-state-edge-prob-cutoff= */
  OPT__param_selsched_insns_to_rename_ = 302,/* --param=selsched-insns-to-rename= */
  OPT__param_selsched_max_lookahead_ = 303,  /* --param=selsched-max-lookahead= */
  OPT__param_selsched_max_sched_times_ = 304,/* --param=selsched-max-sched-times= */
  OPT__param_simultaneous_prefetches_ = 305, /* --param=simultaneous-prefetches= */
  OPT__param_sink_frequency_threshold_ = 306,/* --param=sink-frequency-threshold= */
  OPT__param_sms_dfa_history_ = 307,         /* --param=sms-dfa-history= */
  OPT__param_sms_loop_average_count_threshold_ = 308,/* --param=sms-loop-average-count-threshold= */
  OPT__param_sms_max_ii_factor_ = 309,       /* --param=sms-max-ii-factor= */
  OPT__param_sms_min_sc_ = 310,              /* --param=sms-min-sc= */
  OPT__param_sra_max_propagations_ = 311,    /* --param=sra-max-propagations= */
  OPT__param_sra_max_scalarization_size_Osize_ = 312,/* --param=sra-max-scalarization-size-Osize= */
  OPT__param_sra_max_scalarization_size_Ospeed_ = 313,/* --param=sra-max-scalarization-size-Ospeed= */
  OPT__param_ssa_name_def_chain_limit_ = 314,/* --param=ssa-name-def-chain-limit= */
  OPT__param_ssp_buffer_size_ = 315,         /* --param=ssp-buffer-size= */
  OPT__param_stack_clash_protection_guard_size_ = 316,/* --param=stack-clash-protection-guard-size= */
  OPT__param_stack_clash_protection_probe_interval_ = 317,/* --param=stack-clash-protection-probe-interval= */
  OPT__param_store_merging_allow_unaligned_ = 318,/* --param=store-merging-allow-unaligned= */
  OPT__param_store_merging_max_size_ = 319,  /* --param=store-merging-max-size= */
  OPT__param_switch_conversion_max_branch_ratio_ = 320,/* --param=switch-conversion-max-branch-ratio= */
  OPT__param_threader_debug_ = 321,          /* --param=threader-debug= */
  OPT__param_tm_max_aggregate_size_ = 322,   /* --param=tm-max-aggregate-size= */
  OPT__param_tracer_dynamic_coverage_feedback_ = 323,/* --param=tracer-dynamic-coverage-feedback= */
  OPT__param_tracer_dynamic_coverage_ = 324, /* --param=tracer-dynamic-coverage= */
  OPT__param_tracer_max_code_growth_ = 325,  /* --param=tracer-max-code-growth= */
  OPT__param_tracer_min_branch_probability_feedback_ = 326,/* --param=tracer-min-branch-probability-feedback= */
  OPT__param_tracer_min_branch_probability_ = 327,/* --param=tracer-min-branch-probability= */
  OPT__param_tracer_min_branch_ratio_ = 328, /* --param=tracer-min-branch-ratio= */
  OPT__param_tree_reassoc_width_ = 329,      /* --param=tree-reassoc-width= */
  OPT__param_tsan_distinguish_volatile_ = 330,/* --param=tsan-distinguish-volatile= */
  OPT__param_tsan_instrument_func_entry_exit_ = 331,/* --param=tsan-instrument-func-entry-exit= */
  OPT__param_uninit_control_dep_attempts_ = 332,/* --param=uninit-control-dep-attempts= */
  ...
  OPT_m32 = 1894,                            /* -m32 */
  OPT_m64 = 1895,                            /* -m64 */
  OPT_mabi_altivec = 1896,                   /* -mabi=altivec */
  OPT_mabi_d32 = 1897,                       /* -mabi=d32 */
  OPT_mabi_d64 = 1898,                       /* -mabi=d64 */
  OPT_mabi_elfv1 = 1899,                     /* -mabi=elfv1 */
  OPT_mabi_elfv2 = 1900,                     /* -mabi=elfv2 */
  OPT_mabi_ibmlongdouble = 1901,             /* -mabi=ibmlongdouble */
  OPT_mabi_ieeelongdouble = 1902,            /* -mabi=ieeelongdouble */
  OPT_mabi_no_altivec = 1903,                /* -mabi=no-altivec */
  OPT_mabi_vec_default = 1904,               /* -mabi=vec-default */
  OPT_mabi_vec_extabi = 1905,                /* -mabi=vec-extabi */
  OPT_mads = 1906,                           /* -mads */
  OPT_maix_struct_return = 1907,             /* -maix-struct-return */
  OPT_malign_ = 1908,                        /* -malign- */
  OPT_malign_branch_targets = 1909,          /* -malign-branch-targets */
  OPT_mallow_movmisalign = 1910,             /* -mallow-movmisalign */
  OPT_maltivec = 1911,                       /* -maltivec */
  OPT_malways_hint = 1912,                   /* -malways-hint */
  OPT_mavoid_indexed_addresses = 1913,       /* -mavoid-indexed-addresses */
  OPT_mbig = 1914,                           /* -mbig */
  OPT_mbig_endian = 1915,                    /* -mbig-endian */
  OPT_mbit_align = 1916,                     /* -mbit-align */
  OPT_mbit_word = 1917,                      /* -mbit-word */
  OPT_mblock_compare_inline_limit_ = 1918,   /* -mblock-compare-inline-limit= */
  OPT_mblock_compare_inline_loop_limit_ = 1919,/* -mblock-compare-inline-loop-limit= */
  OPT_mblock_move_inline_limit_ = 1920,      /* -mblock-move-inline-limit= */
  OPT_mblock_ops_unaligned_vsx = 1921,       /* -mblock-ops-unaligned-vsx */
  OPT_mblock_ops_vector_pair = 1922,         /* -mblock-ops-vector-pair */
  OPT_mbss_plt = 1923,                       /* -mbss-plt */
  OPT_mcall_ = 1924,                         /* -mcall- */
  OPT_mcmpb = 1925,                          /* -mcmpb */
  OPT_mcompat_align_parm = 1926,             /* -mcompat-align-parm */
  OPT_mcpu_ = 1927,                          /* -mcpu= */
  OPT_mcrypto = 1928,                        /* -mcrypto */
  OPT_mdebug_ = 1929,                        /* -mdebug= */
  OPT_mdirect_move = 1930,                   /* -mdirect-move */
  OPT_mdlmzb = 1931,                         /* -mdlmzb */
  OPT_meabi = 1932,                          /* -meabi */
  OPT_mefficient_unaligned_vsx = 1933,       /* -mefficient-unaligned-vsx */
  OPT_memb = 1934,                           /* -memb */
  OPT_mfloat128 = 1935,                      /* -mfloat128 */
  OPT_mfloat128_convert = 1936,              /* -mfloat128-convert */
  OPT_mfloat128_hardware = 1937,             /* -mfloat128-hardware */
  OPT_mfp_in_toc = 1938,                     /* -mfp-in-toc */
  OPT_mfprnd = 1939,                         /* -mfprnd */
  OPT_mfriz = 1940,                          /* -mfriz */
  OPT_mfull_toc = 1941,                      /* -mfull-toc */
  /* OPT_mfused_madd = 1942, */              /* -mfused-madd */
  /* OPT_mgen_cell_microcode = 1943, */      /* -mgen-cell-microcode */
  OPT_mgnu_attribute = 1944,                 /* -mgnu-attribute */
  OPT_mhard_dfp = 1945,                      /* -mhard-dfp */
  OPT_mhard_float = 1946,                    /* -mhard-float */
  OPT_mhtm = 1947,                           /* -mhtm */
  OPT_mieee128_constant = 1948,              /* -mieee128-constant */
  OPT_minsert_sched_nops_ = 1949,            /* -minsert-sched-nops= */
  OPT_misel = 1950,                          /* -misel */
  OPT_mlittle = 1951,                        /* -mlittle */
  OPT_mlittle_endian = 1952,                 /* -mlittle-endian */
  OPT_mlong_double_ = 1953,                  /* -mlong-double- */
  OPT_mlongcall = 1954,                      /* -mlongcall */
  /* OPT_mlra = 1955, */                     /* -mlra */
  OPT_mmfcrf = 1956,                         /* -mmfcrf */
  OPT_mmfpgpr = 1957,                        /* -mmfpgpr */
  OPT_mminimal_toc = 1958,                   /* -mminimal-toc */
  OPT_mmma = 1959,                           /* -mmma */
  OPT_mmodulo = 1960,                        /* -mmodulo */
  OPT_mmulhw = 1961,                         /* -mmulhw */
  OPT_mmultiple = 1962,                      /* -mmultiple */
  OPT_mmvme = 1963,                          /* -mmvme */
  OPT_mnewlib = 1964,                        /* -mnewlib */
  OPT_mno_fp_in_toc = 1965,                  /* -mno-fp-in-toc */
  /* OPT_mno_mfpgpr = 1966, */               /* -mno-mfpgpr */
  /* OPT_mno_string = 1967, */               /* -mno-string */
  OPT_mno_sum_in_toc = 1968,                 /* -mno-sum-in-toc */
  OPT_mno_toc = 1969,                        /* -mno-toc */
  OPT_mno_traceback = 1970,                  /* -mno-traceback */
  OPT_mno_update = 1971,                     /* -mno-update */
  OPT_moptimize_swaps = 1972,                /* -moptimize-swaps */
  OPT_mpcrel = 1973,                         /* -mpcrel */
  OPT_mpcrel_opt = 1974,                     /* -mpcrel-opt */
  OPT_mpltseq = 1975,                        /* -mpltseq */
  OPT_mpointers_to_nested_functions = 1976,  /* -mpointers-to-nested-functions */
  OPT_mpopcntb = 1977,                       /* -mpopcntb */
  OPT_mpopcntd = 1978,                       /* -mpopcntd */
  OPT_mpower10 = 1979,                       /* -mpower10 */
  OPT_mpower10_fusion = 1980,                /* -mpower10-fusion */
  OPT_mpower8_fusion = 1981,                 /* -mpower8-fusion */
  OPT_mpower8_fusion_sign = 1982,            /* -mpower8-fusion-sign */
  OPT_mpower8_vector = 1983,                 /* -mpower8-vector */
  OPT_mpower9_minmax = 1984,                 /* -mpower9-minmax */
  OPT_mpower9_misc = 1985,                   /* -mpower9-misc */
  OPT_mpower9_vector = 1986,                 /* -mpower9-vector */
  /* OPT_mpowerpc = 1987, */                 /* -mpowerpc */
  OPT_mpowerpc_gfxopt = 1988,                /* -mpowerpc-gfxopt */
  OPT_mpowerpc_gpopt = 1989,                 /* -mpowerpc-gpopt */
  OPT_mpowerpc64 = 1990,                     /* -mpowerpc64 */
  OPT_mprefixed = 1991,                      /* -mprefixed */
  OPT_mprioritize_restricted_insns_ = 1992,  /* -mprioritize-restricted-insns= */
  OPT_mprivileged = 1993,                    /* -mprivileged */
  OPT_mprototype = 1994,                     /* -mprototype */
  OPT_mquad_memory = 1995,                   /* -mquad-memory */
  OPT_mquad_memory_atomic = 1996,            /* -mquad-memory-atomic */
  OPT_mreadonly_in_sdata = 1997,             /* -mreadonly-in-sdata */
  OPT_mrecip = 1998,                         /* -mrecip */
  OPT_mrecip_precision = 1999,               /* -mrecip-precision */
  OPT_mrecip_ = 2000,                        /* -mrecip= */
  OPT_mregnames = 2001,                      /* -mregnames */
  OPT_mrelative_jumptables = 2002,           /* -mrelative-jumptables */
  OPT_mrelocatable = 2003,                   /* -mrelocatable */
  OPT_mrelocatable_lib = 2004,               /* -mrelocatable-lib */
  OPT_mrop_protect = 2005,                   /* -mrop-protect */
  OPT_msave_toc_indirect = 2006,             /* -msave-toc-indirect */
  OPT_msched_costly_dep_ = 2007,             /* -msched-costly-dep= */
  OPT_msched_epilog = 2008,                  /* -msched-epilog */
  OPT_msched_groups = 2009,                  /* -msched-groups */
  OPT_msched_prolog = 2010,                  /* -msched-prolog */
  OPT_msdata = 2011,                         /* -msdata */
  OPT_msdata_ = 2012,                        /* -msdata= */
  OPT_msecure_plt = 2013,                    /* -msecure-plt */
  OPT_mshlib = 2014,                         /* -mshlib */
  OPT_msim = 2015,                           /* -msim */
  OPT_msingle_pic_base = 2016,               /* -msingle-pic-base */
  OPT_msoft_float = 2017,                    /* -msoft-float */
  OPT_mspeculate_indirect_jumps = 2018,      /* -mspeculate-indirect-jumps */
  OPT_msplat_float_constant = 2019,          /* -msplat-float-constant */
  OPT_msplat_word_constant = 2020,           /* -msplat-word-constant */
  OPT_mstack_protector_guard_offset_ = 2021, /* -mstack-protector-guard-offset= */
  OPT_mstack_protector_guard_reg_ = 2022,    /* -mstack-protector-guard-reg= */
  OPT_mstack_protector_guard_ = 2023,        /* -mstack-protector-guard= */
  OPT_mstrict_align = 2024,                  /* -mstrict-align */
  OPT_mstring = 2025,                        /* -mstring */
  OPT_mstring_compare_inline_limit_ = 2026,  /* -mstring-compare-inline-limit= */
  OPT_msum_in_toc = 2027,                    /* -msum-in-toc */
  OPT_msvr4_struct_return = 2028,            /* -msvr4-struct-return */
  OPT_mtls_size_ = 2029,                     /* -mtls-size= */
  OPT_mtoc = 2030,                           /* -mtoc */
  OPT_mtraceback_ = 2031,                    /* -mtraceback= */
  OPT_mtune_ = 2032,                         /* -mtune= */
  OPT_munroll_only_small_loops = 2033,       /* -munroll-only-small-loops */
  OPT_mupdate = 2034,                        /* -mupdate */
  OPT_mveclibabi_ = 2035,                    /* -mveclibabi= */
  OPT_mvrsave = 2036,                        /* -mvrsave */
  /* OPT_mvrsave_no = 2037, */               /* -mvrsave=no */
  /* OPT_mvrsave_yes = 2038, */              /* -mvrsave=yes */
  OPT_mvsx = 2039,                           /* -mvsx */
  OPT_mvsx_align_128 = 2040,                 /* -mvsx-align-128 */
  /* OPT_mvsx_timode = 2041, */              /* -mvsx-timode */
  OPT_mwarn_altivec_long = 2042,             /* -mwarn-altivec-long */
  OPT_mxl_compat = 2043,                     /* -mxl-compat */
  OPT_myellowknife = 2044,                   /* -myellowknife */
  OPT_n = 2045,                              /* -n */
  OPT_name_sort = 2046,                      /* -name-sort */
  OPT_no_canonical_prefixes = 2047,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 2048,              /* -no-integrated-cpp */
  OPT_no_pie = 2049,                         /* -no-pie */
  OPT_nocpp = 2050,                          /* -nocpp */
  OPT_nodefaultlibs = 2051,                  /* -nodefaultlibs */
  OPT_nolibc = 2052,                         /* -nolibc */
  OPT_nophoboslib = 2053,                    /* -nophoboslib */
  OPT_nostartfiles = 2054,                   /* -nostartfiles */
  OPT_nostdinc = 2055,                       /* -nostdinc */
  OPT_nostdinc__ = 2056,                     /* -nostdinc++ */
  OPT_nostdlib = 2057,                       /* -nostdlib */
  OPT_nostdlib__ = 2058,                     /* -nostdlib++ */
  OPT_o = 2059,                              /* -o */
  OPT_objects = 2060,                        /* -objects */
  OPT_p = 2061,                              /* -p */
  OPT_pass_exit_codes = 2062,                /* -pass-exit-codes */
  /* OPT_pedantic = 2063, */                 /* -pedantic */
  OPT_pedantic_errors = 2064,                /* -pedantic-errors */
  OPT_pg = 2065,                             /* -pg */
  OPT_pie = 2066,                            /* -pie */
  OPT_pipe = 2067,                           /* -pipe */
  OPT_print_file_name_ = 2068,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 2069,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 2070,          /* -print-multi-directory */
  OPT_print_multi_lib = 2071,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 2072,       /* -print-multi-os-directory */
  OPT_print_multiarch = 2073,                /* -print-multiarch */
  OPT_print_objc_runtime_info = 2074,        /* -print-objc-runtime-info */
  OPT_print_prog_name_ = 2075,               /* -print-prog-name= */
  OPT_print_search_dirs = 2076,              /* -print-search-dirs */
  OPT_print_sysroot = 2077,                  /* -print-sysroot */
  OPT_print_sysroot_headers_suffix = 2078,   /* -print-sysroot-headers-suffix */
  OPT_print_value = 2079,                    /* -print-value */
  OPT_quiet = 2080,                          /* -quiet */
  OPT_r = 2081,                              /* -r */
  OPT_remap = 2082,                          /* -remap */
  OPT_reverse_sort = 2083,                   /* -reverse-sort */
  OPT_s = 2084,                              /* -s */
  OPT_save_temps = 2085,                     /* -save-temps */
  OPT_save_temps_ = 2086,                    /* -save-temps= */
  OPT_shared = 2087,                         /* -shared */
  OPT_shared_libgcc = 2088,                  /* -shared-libgcc */
  OPT_shared_libphobos = 2089,               /* -shared-libphobos */
  OPT_size_sort = 2090,                      /* -size-sort */
  /* OPT_specs = 2091, */                    /* -specs */
  OPT_specs_ = 2092,                         /* -specs= */
  OPT_static = 2093,                         /* -static */
  OPT_static_libasan = 2094,                 /* -static-libasan */
  OPT_static_libgcc = 2095,                  /* -static-libgcc */
  OPT_static_libgfortran = 2096,             /* -static-libgfortran */
  OPT_static_libgm2 = 2097,                  /* -static-libgm2 */
  OPT_static_libgo = 2098,                   /* -static-libgo */
  OPT_static_libhwasan = 2099,               /* -static-libhwasan */
  OPT_static_liblsan = 2100,                 /* -static-liblsan */
  OPT_static_libmpx = 2101,                  /* -static-libmpx */
  OPT_static_libmpxwrappers = 2102,          /* -static-libmpxwrappers */
  OPT_static_libphobos = 2103,               /* -static-libphobos */
  OPT_static_libquadmath = 2104,             /* -static-libquadmath */
  OPT_static_libstdc__ = 2105,               /* -static-libstdc++ */
  OPT_static_libtsan = 2106,                 /* -static-libtsan */
  OPT_static_libubsan = 2107,                /* -static-libubsan */
  OPT_static_pie = 2108,                     /* -static-pie */
  /* OPT_std_c__03 = 2109, */                /* -std=c++03 */
  /* OPT_std_c__0x = 2110, */                /* -std=c++0x */
  OPT_std_c__11 = 2111,                      /* -std=c++11 */
  OPT_std_c__14 = 2112,                      /* -std=c++14 */
  OPT_std_c__17 = 2113,                      /* -std=c++17 */
  /* OPT_std_c__1y = 2114, */                /* -std=c++1y */
  /* OPT_std_c__1z = 2115, */                /* -std=c++1z */
  OPT_std_c__20 = 2116,                      /* -std=c++20 */
  OPT_std_c__23 = 2117,                      /* -std=c++23 */
  /* OPT_std_c__2a = 2118, */                /* -std=c++2a */
  /* OPT_std_c__2b = 2119, */                /* -std=c++2b */
  OPT_std_c__98 = 2120,                      /* -std=c++98 */
  OPT_std_c11 = 2121,                        /* -std=c11 */
  OPT_std_c17 = 2122,                        /* -std=c17 */
  /* OPT_std_c18 = 2123, */                  /* -std=c18 */
  /* OPT_std_c1x = 2124, */                  /* -std=c1x */
  OPT_std_c2x = 2125,                        /* -std=c2x */
  /* OPT_std_c89 = 2126, */                  /* -std=c89 */
  OPT_std_c90 = 2127,                        /* -std=c90 */
  OPT_std_c99 = 2128,                        /* -std=c99 */
  /* OPT_std_c9x = 2129, */                  /* -std=c9x */
  OPT_std_f2003 = 2130,                      /* -std=f2003 */
  OPT_std_f2008 = 2131,                      /* -std=f2008 */
  OPT_std_f2008ts = 2132,                    /* -std=f2008ts */
  OPT_std_f2018 = 2133,                      /* -std=f2018 */
  OPT_std_f95 = 2134,                        /* -std=f95 */
  OPT_std_gnu = 2135,                        /* -std=gnu */
  /* OPT_std_gnu__03 = 2136, */              /* -std=gnu++03 */
  /* OPT_std_gnu__0x = 2137, */              /* -std=gnu++0x */
  OPT_std_gnu__11 = 2138,                    /* -std=gnu++11 */
  OPT_std_gnu__14 = 2139,                    /* -std=gnu++14 */
  OPT_std_gnu__17 = 2140,                    /* -std=gnu++17 */
  /* OPT_std_gnu__1y = 2141, */              /* -std=gnu++1y */
  /* OPT_std_gnu__1z = 2142, */              /* -std=gnu++1z */
  OPT_std_gnu__20 = 2143,                    /* -std=gnu++20 */
  OPT_std_gnu__23 = 2144,                    /* -std=gnu++23 */
  /* OPT_std_gnu__2a = 2145, */              /* -std=gnu++2a */
  /* OPT_std_gnu__2b = 2146, */              /* -std=gnu++2b */
  OPT_std_gnu__98 = 2147,                    /* -std=gnu++98 */
  OPT_std_gnu11 = 2148,                      /* -std=gnu11 */
  OPT_std_gnu17 = 2149,                      /* -std=gnu17 */
  /* OPT_std_gnu18 = 2150, */                /* -std=gnu18 */
  /* OPT_std_gnu1x = 2151, */                /* -std=gnu1x */
  OPT_std_gnu2x = 2152,                      /* -std=gnu2x */
  /* OPT_std_gnu89 = 2153, */                /* -std=gnu89 */
  OPT_std_gnu90 = 2154,                      /* -std=gnu90 */
  OPT_std_gnu99 = 2155,                      /* -std=gnu99 */
  /* OPT_std_gnu9x = 2156, */                /* -std=gnu9x */
  /* OPT_std_iso9899_1990 = 2157, */         /* -std=iso9899:1990 */
  OPT_std_iso9899_199409 = 2158,             /* -std=iso9899:199409 */
  /* OPT_std_iso9899_1999 = 2159, */         /* -std=iso9899:1999 */
  /* OPT_std_iso9899_199x = 2160, */         /* -std=iso9899:199x */
  /* OPT_std_iso9899_2011 = 2161, */         /* -std=iso9899:2011 */
  /* OPT_std_iso9899_2017 = 2162, */         /* -std=iso9899:2017 */
  /* OPT_std_iso9899_2018 = 2163, */         /* -std=iso9899:2018 */
