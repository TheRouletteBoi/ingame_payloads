...
elseif(UNIX)
set(PS3_PPU_TOOLCHAIN_PATH ${CMAKE_CURRENT_SOURCE_DIR}/toolchain/bin/linux-arm64/ppu/bin/)
endif()

set(triple powerpc64-eabi-freebsd-elfv1)

set(CMAKE_LINKER ${PS3_PPU_TOOLCHAIN_PATH}ld${CMAKE_EXECUTABLE_SUFFIX})
set(CMAKE_AR ${PS3_PPU_TOOLCHAIN_PATH}ppu-ar)
set(CMAKE_OBJCOPY ${PS3_PPU_TOOLCHAIN_PATH}ppu-objcopy)

SET(CMAKE_ASM_COMPILER ${PS3_PPU_TOOLCHAIN_PATH}ppu-gcc)
set(CMAKE_C_COMPILER ${PS3_PPU_TOOLCHAIN_PATH}ppu-gcc)
set(CMAKE_CXX_COMPILER ${PS3_PPU_TOOLCHAIN_PATH}ppu-g++)
